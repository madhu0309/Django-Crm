...
class OpportunityModel(object):
    def setUp(self):
        ...
        self.account = Account.objects.create(
            ...
            billing_street="kphb", billing_city="hyderabad",
            billing_postcode="584", billing_country='IN',
...
class EditOpportunityTestCase(OpportunityModel, TestCase):
    ...
    def test_update_opportunity(self):
        ...
        data = {
            'name': "madhurima", 'amount': "478", 'stage': "QUALIFICATION",
