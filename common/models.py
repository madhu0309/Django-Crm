...
class Attachments(models.Model):
    ...
    def file_type(self):
        ...
        if (len(name_ext_list) > 1):
            ...
            if self.is_attachment_audio(ext):
                return ("audio", "fa fa-file-audio")
            elif self.is_attachment_video(ext):
                return ("video", "fa fa-file-video")
            elif self.is_attachment_image(ext):
                return ("image", "fa fa-file-image")
            elif self.is_attachment_pdf(ext):
                return ("pdf", "fa fa-file-pdf")
            elif self.is_attachment_code(ext):
                return ("code", "fa fa-file-code")
            elif self.is_attachment_text(ext):
                return ("text", "fa fa-file-alt")
            elif self.is_attachment_sheet(ext):
                return ("sheet", "fa fa-file-excel")
            elif self.is_attachment_zip(ext):
                return ("zip", "fa fa-file-archive")
            return ("file", "fa fa-file")
        return ("file", "fa fa-file")


    def get_file_type_display(attachment):
        if attachment:
            return attachment.file_type()[1]
        else:
            return None
